...
var EventTypeService = /** @class */ (function () {
    function EventTypeService(_http) {
        this._http = _http;
    }
    EventTypeService.prototype.getEventTypes = function () {
        ...
        return this._http.get(app_settings_1.APP_SETTINGS.EVENT_TYPES_URL + '?no_page', options).pipe(operators_1.map(function (response) { return response.json(); }), 
        // .do(data => console.log('Samples data: ' + JSON.stringify(data)))
        operators_1.catchError(this.handleError));
    };
    EventTypeService.prototype.handleError = function (error) {
        console.error(error);
