...
public static get countyTooltip(): string { return 'County of location (or equivalent, such as parish or burough in the United States). \n\n If event encompasses multiple counties, create separate locations for each.'; }
public static get editCountyTooltip(): string { return 'County of location (or equivalent, such as parish or burough in the United States).'; }
...
public static get ageBiasTooltip(): string { return 'Age bias in the species affected at this location. \n\n Options are: "No noticable bias" - age bias was assessed but no bias detected; "Unknown" - age bias not assessed; "Mostly young" - most animals affected were young; "Mostly adults" - most animals affected were adults.'; }
public static get editAgeBiasTooltip(): string { return 'Age bias in the species affected at this location.'; }

public static get sexBiasTooltip(): string { return 'Sex bias in the species affected at this location. \n\n Options are: "No noticable bias" - sex bias was assessed but no bias detected; "Unknown" - sex bias not assessed; "Mostly Male" - most animals affected were male; "Mostly Female" - most animals affected were female.'; }
...
public static get flywayTooltip(): string { return 'United State\'s Fish and Wildlife Service administrative Flyway at this location.'; }
public static get nwhcCarcassSubApprovalTooltip(): string { return 'For USGS National Wildlife Health Center (NWHC) to fill out after a diagnostic service request has has been received. \n\nOptions are: "Yes" - service request has been approved; "No" - service request has not been approved; "Maybe" - service request might be approved but NWHC needs more information via comments.'; }
...
public static get regemailAddressTooltip(): string { return 'Email address, preferably work account for Natural Resouces Management Professionals.'; }
...
public static get regTermsOfUseTooltip(): string { return 'Natural Resource Management Professionals are required to check this box acknowleging the terms of use before becoming authorized WHISPers users.'; }
...
public static get regRoleTooltip(): string { return 'Role being requested by registering user. \n\n Options are: "User" - can submit data, edit self-created data, and view non-public data within own organzation; "Manager" - anything a "User" can do, plus can edit any data within own organization; "Administrator" - anything a "Manager" can do, plus can validate and delete users and user info within own organization.'; }
