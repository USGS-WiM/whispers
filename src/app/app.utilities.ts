...
export class APP_UTILITIES {
  ...
  public static parseSearch(search): any {
    ...
    if (search.data.affected_count_operator) {
      parsedSearch.affected_count_operator =
        search.data.affected_count_operator;
    }
    ...
    if (search.data.diagnosis_type) {
      parsedSearch.diagnosis_type = JSON.parse(
        "[" + search.data.diagnosis_type + "]"
      );
    }
    ...
    if (search.data.administrative_level_one) {
      parsedSearch.administrative_level_one = JSON.parse(
        "[" + search.data.administrative_level_one + "]"
      );
    }
    if (search.data.administrative_level_two) {
      parsedSearch.administrative_level_two = JSON.parse(
        "[" + search.data.administrative_level_two + "]"
      );
    }
