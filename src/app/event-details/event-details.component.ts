...
export class EventDetailsComponent implements OnInit {
  ...
  downloadEventReport() {
    ...
    // associatedEvents
    const associatedEvents = data.eventgroups[0].events.join(', ');
    ...
    const docDefinition = {
      ...
      footer: function (currentPage, pageCount) {
        return {
          ...
          style: 'smallest',
          columns: [
            'Report generated by Jenny Chipault (U.S. Geological Survey – National Wildlife Health Center) from https://whispers.usgs.gov/event/200174 on' + date + '. \n For more information about this event, connect with the Contact Organization. For more information about WHISPers, see “About” at https://whispers.usgs.gov.',
            { text: 'Page ' + currentPage.toString() + ' of ' + pageCount, alignment: 'right' } // TODO Add report date
          ]
        };
      },
      content: [
          ...
          columns: [
            {
              ...
              table: {
                widths: [100, 200],
                body: [
                  [{ border: [false, false, true, false], text: 'Associated Events', bold: true }, associatedEvents],
                ]
              },
              layout: { defaultBorder: false }
            }
          ...
          columns: [
            {
              ...
              table: {
                widths: [100, 200],
                body: [
                  [{ border: [false, false, true, false], text: 'Event Visibility', bold: true }, eventVisibility],
                ]
              },
              layout: { defaultBorder: false }
            }
