...
export class EventPublicReportComponent implements OnInit, AfterViewInit {
  ...
  downloadEventReport() {
    ...
    domtoimage.toPng(document.getElementById('natMap'), { quality: 0.95, width: 400, height: 300 })
    ...
    window.addEventListener('natmap_ready', () => {
      domtoimage.toPng(document.getElementById('detailMap'), { quality: 0.95, width: 400, height: 300 })
        .then(function (dataUrl) {
