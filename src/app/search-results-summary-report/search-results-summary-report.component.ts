...
export class SearchResultsSummaryReportComponent implements OnInit {
  ...
  downloadResultsSummaryReport() {
    ...
    let legendURL;
    let event;
    window.removeEventListener('image_ready', event, false);
    ...
    // I know I know, I hate that I'm using timeouts too. This is here because if the pdfmake functions run before the images are are ready then they end up undefined which causes the whole thing to fail
  }
}
