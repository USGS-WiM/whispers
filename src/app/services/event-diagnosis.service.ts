...
export class EventDiagnosisService {
  ...
  public create(formValue): Observable<EventDiagnosis> {
    ...
    return this._http.post(APP_SETTINGS.EVENT_DIAGNOSES_URL, formValue, options)
      .map((response: Response) => <EventDiagnosis>response.json())
      .catch(this.handleError);
  ...
  public update(formValue): Observable<EventDiagnosis> {
    ...
    return this._http.put(APP_SETTINGS.EVENT_DIAGNOSES_URL + formValue.id + '/', formValue, options)
      .map((response: Response) => <EventDiagnosis>response.json())
      .catch(this.handleError);
  }
  ...
  public delete(id): Observable<any> {
    ...
    return this._http.delete(APP_SETTINGS.EVENT_DIAGNOSES_URL + id + '/', options)
